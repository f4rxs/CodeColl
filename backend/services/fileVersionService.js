const FileVersion = require('../models/postgresql/fileVersion');

const createFileVersion = async (fileId, versionData) => {
    try {
...
const findFileVersions = async (fileId) => {
    try {
...
const findLatestFileVersion = async (fileId) => {
    try {
